...
public class AnyHandlerException {
    ...
    public ResponseEntity handlerExceptionProdutoNaoEncontrado(NotFound e){
        return new ResponseEntity<>(e.getLocalizedMessage(), new HttpHeaders(), HttpStatus.NOT_FOUND);
    }
